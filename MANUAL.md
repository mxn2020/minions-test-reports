# Manual Setup Steps for Minions Test-reports
...
Go to **GitHub → mxn2020/minions-test-reports → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-test-reports` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-test-reports-web`
- **GitHub repo**: `mxn2020/minions-test-reports`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `test-reports.minions.wtf`

### Documentation
- **Netlify site name**: `minions-test-reports-docs`
- **GitHub repo**: `mxn2020/minions-test-reports`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `test-reports.minions.help`

### Blog
- **Netlify site name**: `minions-test-reports-blog`
- **GitHub repo**: `mxn2020/minions-test-reports`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `test-reports.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `test-reports.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `test-reports.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `test-reports.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-test-reports/sdk`](https://www.npmjs.com/package/@minions-test-reports/sdk)
- CLI: [`@minions-test-reports/cli`](https://www.npmjs.com/package/@minions-test-reports/cli)
...
Your package: [`minions-test-reports`](https://pypi.org/project/minions-test-reports/)
...
| Item | Value |
|------|-------|
| Project | `minions-test-reports` |
| SDK (npm) | `@minions-test-reports/sdk` |
| CLI (npm) | `@minions-test-reports/cli` |
| Python (PyPI) | `minions-test-reports` |
| GitHub | `github.com/mxn2020/minions-test-reports` |
| Docs domain | `test-reports.minions.help` |
| Blog domain | `test-reports.minions.blog` |
| App domain | `test-reports.minions.wtf` |
