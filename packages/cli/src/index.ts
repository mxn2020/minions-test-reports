...
/**
 * @minions-test-reports/cli — CLI for Minions Test-reports
 *
...
import { customTypes } from '@minions-test-reports/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Test-reports'));
        console.log(chalk.dim('Aggregated results, regression diffs, quality trends, and coverage maps'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-test-reports/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-test-reports/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-test-reports')}`);
